  ...
  return (
    <div className="min-h-screen bg-slate-50 pt-20 md:pt-32 pb-16 md:pb-20">
      <div className="container mx-auto px-4 max-w-4xl">
          ...
          {filteredFaqs.map((faq, i) => (
            <div key={i} className="bg-white border border-slate-100 rounded-2xl overflow-hidden shadow-sm transition-all">
              <button
                ...
                className="w-full flex items-center justify-between px-5 md:px-6 py-4 md:py-5 text-left hover:bg-slate-50/50 transition-colors"
              >
              ...
              {openIndex === i && (
                <div className="pb-5 md:pb-6 pl-14 md:pl-16 pr-5 md:pr-8 animate-in slide-in-from-top-2 duration-300">
                  <p className="text-slate-600 text-[12px] md:text-base leading-relaxed font-medium">
                    {faq.answer}
                  </p>
                </div>
              )}
        ...
        <div className="mt-12 md:mt-16 bg-primary rounded-[2rem] md:rounded-[2.5rem] p-8 md:p-12 text-center text-white relative overflow-hidden shadow-xl">
           ...
           <div className="relative z-10 space-y-4 md:space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4 pt-2">
                 <Button className="w-full sm:w-auto bg-secondary text-primary font-black px-8 h-12 rounded-xl hover:bg-white transition-all text-[11px] md:text-xs uppercase tracking-widest flex items-center justify-center gap-2">
                    <MessageCircle className="w-4 h-4" /> Chat qua Zalo
                 </Button>
                 <Button variant="outline" className="w-full sm:w-auto border-white/20 text-white font-black px-8 h-12 rounded-xl hover:bg-white/10 transition-all text-[11px] md:text-xs uppercase tracking-widest flex items-center justify-center gap-2">
