          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card className="border-none shadow-sm rounded-3xl p-8 bg-white">
              ...
              <div className="text-slate-600 leading-loose whitespace-pre-line">
                {typeof initialCourse.content === 'string' 
                  ? initialCourse.content 
                  : (initialCourse.content as any)?.overview || 'Thông tin chi tiết đang được cập nhật...'}
              </div>
            </Card>
          </div>
              ...
              <CardContent className="p-8 space-y-6">
                ...
                <div className="flex flex-col gap-4 text-sm text-slate-500 font-medium">
                  <div className="flex items-center gap-3">
                    <Clock className="w-5 h-5 text-secondary" /> <span>Thời lượng: {(initialCourse as any).sessions || (initialCourse as any).duration || 'Đang cập nhật'}</span>
                  </div>
                  <div className="flex items-center gap-3">
